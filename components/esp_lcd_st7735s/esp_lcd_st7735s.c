...
esp_err_t esp_lcd_new_panel_st7735s(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config, esp_lcd_panel_handle_t *ret_panel)
{
    ...
    ESP_GOTO_ON_FALSE(st7735s, ESP_ERR_NO_MEM, err, TAG, "no mem for st7735 panel");

    st7735s->x_gap = COLSTART;
    st7735s->y_gap = ROWSTART;
    ...
    {
    case 16: // RGB565
        st7735s->colmod_val = 0x05;
        st7735s->fb_bits_per_pixel = 16;
        break;
    case 18: // RGB666
        st7735s->colmod_val = 0x06;
...
static esp_err_t panel_st7735s_reset(esp_lcd_panel_t *panel)
{
    ...
    ESP_LOGD(TAG, "reset st7735s panel @%p", st7735s);
...
st7735s_lcd_init_cmd_t st7735s_init_cmds[] = {
    // Rcmd1
    ...
    {ST7735_CASET, (uint8_t[]){0x00, 0x00, 0x00, 0x9F}, 4, 0},                                                                            // For ST7735S
    {ST7735_RASET, (uint8_t[]){0x00, 0x00, 0x00, 0x4F}, 4, 0},                                                                            // For ST7735S
...
static esp_err_t panel_st7735s_init(esp_lcd_panel_t *panel)
{
    st7735s_panel_t *st7735s = __containerof(panel, st7735s_panel_t, base);
    esp_lcd_panel_io_handle_t io = st7735s->io;
    ESP_LOGI(TAG, "init st7735s panel @%p", st7735s);
    ...
    else
    {
        ...
        init_cmds_size = sizeof(st7735s_init_cmds) / sizeof(st7735s_lcd_init_cmd_t);
    }
